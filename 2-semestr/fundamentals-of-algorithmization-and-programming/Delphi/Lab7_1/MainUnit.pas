...
implementation
uses
    IncidentListUnit, AddTopUnit, MatrixUnit, Clipbrd;
...
var
    ...
    CommonBaseTopCount, MaxSecondaryTopCount: Word;
...
begin
    ...
    begin
        ...
        AddTopUnit.MaxTopCount := TopCount;
        EditImageHeight();
        DrawList;
    end;
end;
...
begin
    MatrixForm.ClientWidth := 700;
    MatrixForm.ClientHeight := 600;
    MatrixForm.Position := poDesktopCenter;
...
procedure AddTopToProject(DestTop, Top: Word);
begin
    AddTop(DestTop, Top);
            ...
            begin
                ...
                begin
                    ...
                    if AddTopForm.ModalResult = mrOK then
                        AddTopToProject(DestTop, StrToInt(AddTopForm.TopValueEdit.Text));
                end;
            end;
        mbRight:
        begin
...
begin
    MessageBox(Handle, '1. Введите в соответствующее поле количество вершин графа (от 1 до 99) и нажмите "Построить".' + #13#10 + '2. Добавьте к каждой вершине графа все вершины, с которой она связана.' + #13#10 + '3. Нажмите кнопку "Преобразовать".' + #13#10 + '4. Получите результат!'+ #13#10 + '5. В случае ввода из файла убедитесь, что файл содержит количество вершин а затем в каждой новой строке все связанные вершины через пробел.', 'Инструкция', MB_OK Or MB_ICONINFORMATION);
end;
